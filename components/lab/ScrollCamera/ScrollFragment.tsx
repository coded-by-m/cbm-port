 ...
 *
 * Mesma base visual de Project Fragments / HTML Overlay (reaproveitada), mas o
 * destaque é dirigido pelo scroll (via `store.activeId`), não por hover — não
 * há handlers de ponteiro aqui. Quando ativo, projeta o ápice para a tela e
 * ancora o card HTML (mesma ponte 3D→2D do HTML Overlay).
 */
