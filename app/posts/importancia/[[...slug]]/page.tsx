 ...
 *
 *  /posts/importancia        → contact-sheet dos 5 slides (revisão)
 *  /posts/importancia/2      → só o slide 2, 1080×1350 (export PNG)
 */
export default function Page({ params }: { params: { slug?: string[] } }) {
  ...
  return (
    ...
    >
      ...
      >
        Carrossel · Importância de um bom site · 1080×1350
      </p>
      {SLIDES.map((slide, i) => (
        <div
          key={i}
